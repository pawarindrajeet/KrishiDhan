...
* [Architecture & Routes](https://www.google.com/search?q=%23architecture--routes)
...
2. Create the database: `CREATE DATABASE krishidhan_db;`
3. Run the raw SQL queries found in `database/db_setup.sql` to generate the core tables (users, crops, cart, etc.).
